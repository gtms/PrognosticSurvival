...
Within the 114 studies assayed in our analysis, \textsf{GSE9893-breast} was
among those with a higher fraction of genes associated with outcome at a
...
vignette of the \texttt{SNAGEE} package (accessible by evaluating the command
